      ...
      if (this.state.selectedCourse !== "Course") {
        ...
        xhr.addEventListener('load', () => {
          ...
          if (data !== "")
            ...
            toast.error("Failed to find a group")

        })
        const URL = 'http://localhost:8080/matching/' + this.state.selectedCourse + '/users/' + getSessionCookie().email;
            ...
            <Form>
                <Form.Group controlId="formBasicRange">
                    ...
                    <RangeSlider
                        ...
                        tooltip='auto'
                        defaultValue={() => {
                            this.getSpecificUserAbility(abilityName)
                        }}
                        value={this.getAbilityValue(abilityName)}
                        onChange={e => {
                            this.updateAbilityValue(e.target.value, abilityName);
                        }}
                    />
                </Form.Group>
            </Form>
